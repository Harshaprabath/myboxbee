...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"> Ready to ship Box</li>
        </ol>
    </div>
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="table-responsive p-3">
                <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <input type="hidden" name="type" value="shipbox">
                    <input type="hidden" name="pimage" value="{{$c->image}}">
                      <button class="btn-danger btn" type="submit">Remove</button>
                      </form>
                                &nbsp;
                              <a class="btn btn-info" href="/admin/ready-edit-box/{{$c->id}}">Edit</a>
                            </td>
