    ...
    <div class="dropdown">
        <a class="nav-link  bag position-relative" href="/cart"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="/checkout"
                    class="dropdown-item border border-1 bg-primary text-white cart-item-checkout-btn"
                    >Chekcout</a>
