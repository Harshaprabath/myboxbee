    ...
    <div class="container">
        <div class="main-body m-auto">
            ...
            $shippingCost = $s->price;
                $total = (float)ShoppingCart::subtotal() + (float)$s->price;
                @endphp
            @endforeach
            <form wire:submit.prevent="placeOrder({{$shippingCost}}, {{$total}})">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row" style="display:flex">
                                    ...
                                    <div class="col-md-6"
                                        ...
                                        <label  wire:click.prevent="setDeliveryOption(1)" style="cursor:pointer">
                                            <h6>Cash On Delivery</h6>
                                            {{-- <input type="radio" name="test" value="" checked> --}}
                                            <img src="{{asset('img/cash.png')}}" alt="" width="100%"
                                                style="height:100px" class="{{$deliveryOption == 1 ? 'active-border':''}}">
                                        </label>
                                    </div>
                                    <div class="col-md-6"
                                        style="justify-content:center;display:flex;background-color: #eff0f1;padding: 8px;">
                                        <label wire:click.prevent="setDeliveryOption(0)" style="cursor:pointer">
                                            <h6>Online Pyament</h6>
                                            {{-- <input type="radio" name="test" value="" checked> --}}
                                            <img src="{{asset('img/cash.png')}}" alt="" width="100%"
                                                style="height:100px" class="{{$deliveryOption == 0 ? 'active-border':''}}">
                                        </label>
                                    </div>
                                </div>
                                <br>
                                <span id="method"
                                    style="background-color: #090909bf;color: white;font-weight: bold;padding: 4px 14px;border-radius: 25px;">
                                {{$deliveryOption == 1 ? 'Cash On Delivery' : 'Online Pyament'}}
                                </span>
                                <hr>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="text-secondary">
                                        ...
                                        @error('lastName') <div class="error text-danger">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="text-secondary">
                                        ...
                                        @error('country') <div class="error text-danger">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div class="col-sm- text-secondary">
                                            ...
                                            @error('city') <div class="error text-danger">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div class="col-sm- text-secondary">
                                            ...
                                            @error('district') <div class="error text-danger">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div class="col-sm- text-secondary">
                                            ...
                                            @error('postalCode') <div class="error text-danger">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="item">
                                            <div class="row flex-nowrap items-center py-2">
                                                            ...
                                                            <div class="image">
                                                                ...
                                                                <div class="embed-responsive embed-responsive-1by1"
                                                                    ...
                                                                    <div class="embed-responsive-item text-center"><img
                                                                            src="{{asset('upload') }}/{{$cartItem->options->image}}"
                                                                            class="w-100" alt=""></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-auto col-lg-3 grand">
                                                    <p class="text-right grandtotal ">LKR {{
                                ...
                                <div class=" mb-4">
                                    ...
                                    <div class="row subtotal" style="font-size: 20px;">
                                        ...
                                        <div class="col-auto ">
                                            <p>
                                                ...
                                                @php
                                                     $orderTotal = (float)ShoppingCart::subtotal() + (float)$s->price
                                                     @endphp 
                                                @endforeach 
                                    ...
                                    <div class="row subtotal" style="font-size: 20px;">
                                        ...
                                        <div class="col-auto ">
                                            <p id="total">
                                                LKR {{number_format($orderTotal??0, 2)}}
                                            </p>
                                            {{-- <input type="hidden" value="{{ShoppingCart::subtotal()}}" wire:model="subtotal"> --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button class="btn col-md-12" style="background-color: black;color: white;"
                            id="placeorder">PLACE
                            ORDER</button>
                    </div>
                </div>
