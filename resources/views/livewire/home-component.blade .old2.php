...
<style>
    ...
    @media (min-width: 992px)and (max-width: 1023px) {
        ...
        .c_box{
            ...
            transition: 999999999999999999s;
            transition-duration: 99999999999999s;
    ...
    @media (min-width: 1279px)and (max-width: 1341px) {
        .c_col-md-3 {
            -ms-flex: 0 0 25%;
            flex: 0 0 25%;
            max-width: 50%;
    ...
    @media (min-width: 1341px)and (max-width: 1433px) {
        .c_col-md-3 {
            -ms-flex: 0 0 25%;
            flex: 0 0 25%;
            max-width: 50%;
