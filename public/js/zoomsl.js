...
(function ($, global) {
    ...
    $.extend(sergelandimagezoomer, {
        ...
        dsetting: { //default settings
            ...
            stepzoom: 0.1, // шаг зуммирования при прокрутке колеса мыши					
            zoomrange: [2, 2], // диапазон зуммирования
            zoomstart: 1, // стартовая установка зуммирования
            ...
            leftoffset: 8, // отступ слева от tmb картинки
            rightoffset: 8, // отступ справа от tmb картинки
